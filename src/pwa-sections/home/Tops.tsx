...
import { Avatar, Box, Card, Stack, Tab, Tabs, Typography, styled } from '@mui/material';
      ...
      <Stack spacing={2}>
        ...
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <Tabs value={tabValue} onChange={handleChange} aria-label="basic tabs example">
            <TabStyle
              active={tabValue === 0}
              label={<FormattedMessage {...HomeMessages.company} />}
              {...a11yProps(0)}
            />
            <TabStyle active={tabValue === 1} label={<FormattedMessage {...HomeMessages.ngo} />} {...a11yProps(1)} />
            <TabStyle active={tabValue === 2} label={<FormattedMessage {...HomeMessages.people} />} {...a11yProps(2)} />
          </Tabs>
        </Box>
