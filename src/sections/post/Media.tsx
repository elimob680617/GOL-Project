...
export type IMedias = {
  ...
  uploadingInformations?: IUploadingInformations | null;
...
const Media: FC<IMedias> = (props) => {
  ...
  useEffect(() => {
    if (uploadingUiniqueId) {
      setUploadedFilesIds((prev) => [...prev, uploadingInformations?.uniqueId as string]);
    }
  }, [uploadingInformations?.uniqueId, uploadingUiniqueId]);
